...
public:
	...
	const momentum_20_data& get_momentum_20_data() const { return momentum_20_data_obj; }
	ep_ratio_data& get_ep_ratio_data() { return ep_ratio_data_obj; }
	const ep_ratio_data& get_ep_ratio_data() const { return ep_ratio_data_obj; }
	log_mcap_data& get_log_mcap_data() { return log_mcap_data_obj; }
	const log_mcap_data& get_log_mcap_data() const { return log_mcap_data_obj; }
	volatility_20_data& get_volatility_20_data() { return volatility_20_data_obj; }
	const volatility_20_data& get_volatility_20_data() const { return volatility_20_data_obj; }
	turnover_20_data& get_turnover_20_data() { return turnover_20_data_obj; }
	const turnover_20_data& get_turnover_20_data() const { return turnover_20_data_obj; }
